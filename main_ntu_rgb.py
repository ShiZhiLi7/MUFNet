...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='config/ntu_xsub/train_rgb.yaml',
...
class Processor():
    ...
    def load_model(self):
        ...
        model = import_class(self.arg.model).from_pretrained('efficientnet-b7', num_classes=60)
    ...
    def eval(self, epoch):
        with torch.no_grad():
            ...
            if accuracy > self.best_acc:
                self.print_log(
                    f'Last epoch to save weight and checkpoint.!!!!!!! !!!!!!!!!!!!!!!!!!!!!!!!!!!! Epoch number is {epoch + 1}')
