...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph = 'graph.ntu_rgb_d.Graph', graph_args=dict(), in_channels=3,
    ...
    def forward(self, x):
        ...
        # N*M,C,T,V
        c_new = x.size(1)
        x = x.view(N, M, c_new, -1, V).permute(0, 2, 3, 4, 1).contiguous()
